...
public class ForiegnExchange {
    ...
    public static void ConvertCurrency() {
        ...
        if (currencyChoice > 0 && currencyChoice <= 15) { //you guys need to include 15 
            ...
            System.out.print("Enter the routing number for the account you would like to transfer this to? ");
        	...
        	if (response == 1)
        	{
        		...
        		System.out.println("--------------------");
                System.out.println("Transferring money to " + accountnumber + " ...");
                try {
                    Thread.sleep(3000);
        		...
        		if (resp == 1)
        		{
                    ...
                    Transactions.amount = String.valueOf(totalAmount);
