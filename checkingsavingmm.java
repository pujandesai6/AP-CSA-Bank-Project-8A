...
class MoneyMarketAccount extends GeneralAccount
{
    private static ArrayList<MoneyMarketAccount> MoneyMarketList = new ArrayList<MoneyMarketAccount>();
    
    private int MoneyMarketAccountNumber;
    private static double minimumStartingBalance = 0.0;
    
    //Constructors
    public MoneyMarketAccount(String accountName, String FullLegalName, double balance)
    {
        super(accountName, FullLegalName, balance);
        MoneyMarketAccountNumber = (int)(Math.random() * 999999999);
    }
    ...
    public static void promptCreate()
    {
        ...
        while(!(ask.equals("n")))
        {
            System.out.print("Would you like to make a new money market account? [y/n]: ");
            ask = test.nextLine();
    ...
    public static void promptTransaction()
    {
        ...
        System.out.println("Which money market account would you like to perform a transaction on?");
        for(int i = 0; i < MoneyMarketList.size(); i++)
        {
            System.out.println((i+1) + ". " + MoneyMarketList.get(i).getAccountName());
        }
    ...
    //Create Account
    public static void createMoneyMarketAccount()
    {
        Scanner test = new Scanner(System.in);
        System.out.println("What is the name on the money market account?");
        String accountName = test.nextLine();
        ...
        MoneyMarketAccount moneymarket = new MoneyMarketAccount(accountName, FullLegalName, balance);
        MoneyMarketList.add(check);
        System.out.println("Your checking account was created successfully!\n");
    }
}